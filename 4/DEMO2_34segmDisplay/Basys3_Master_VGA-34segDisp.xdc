# This file is a general .xdc for the BaRYs3 rev B board
...
set_property PACKAGE_PIN W5 [get_ports CLK]							
	...
	create_clock -add -name RYs_clk_pin -period 10.00 -waveform {0 5} [get_ports CLK]
 
## Switches
set_property PACKAGE_PIN V17 [get_ports {MSG_SEL}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MSG_SEL}]
